...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="adicionales/css/fullcalendar.min.css">
    <link rel="stylesheet" type="text/css" href="adicionales/css/home.css">
...
<body>
   ...
   <!--------------------------------------------------------------------------------------------->
    ...
    <script src ="adicionales/js/jquery-3.0.0.min.js"> </script>
    <script src="adicionales/js/popper.min.js"></script>
    <script src="adicionales/js/bootstrap.min.js"></script>

    <script type="text/javascript" src="adicionales/js/moment.min.js"></script>	
    <script type="text/javascript" src="adicionales/js/fullcalendar.min.js"></script>
    <script src='adicionales/locales/es.js'></script>
